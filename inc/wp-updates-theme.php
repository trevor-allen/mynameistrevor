...
new WPUpdatesThemeUpdater_1620( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_1620') ) {
    class WPUpdatesThemeUpdater_1620 {
